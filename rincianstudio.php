...
if (isset($_POST['delete'])) {
    $sql1 = "DELETE FROM studio WHERE Id_studio = '$id'";
...
if (isset($_POST['edit'])) {
    ...
    $sql2 = "UPDATE studio SET 
            Nama_studio='$nama_studio',
            Alamat_studio='$alamat_studio'
        WHERE Id_studio = '$id'
    ";
    ...
    if ($updateQuery) {
        ...
        header("Refresh: 0; url=rincianstudio.php?id=$id");
    } else {
        echo mysqli_error($conn);
    }
}
...
<head>
    ...
    <title>BACKDOOR19 - Rincian Studio</title>
...
<body class="bg-gradient">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Rincian Studio</h1>
                                    </div>
    ...
    <div class="text-center" type="text" class=" text-center"><a href="tambahstudio.php">
            < Kembali</a>
    </div>
